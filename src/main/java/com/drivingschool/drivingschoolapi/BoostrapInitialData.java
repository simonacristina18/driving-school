package com.drivingschool.drivingschoolapi;//package com.baeldung.springbootreact;
//
...
//        for (int i = 0; i < 10; i++) {
//            clientRepository.save(new Client(faker.name().fullName(), faker.internet().emailAddress(), faker.internet().phoneNumber()));
//        }
//    }
//}
